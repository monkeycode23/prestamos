...
export default function SignUpForm() {
  ...
  const validationFields = async () => {
    ...
    let _errors = await validate({
      username: [validations.required({ message: 'Este campo es requerido' }),
      ...
      validations.alphanumeric({ message: 'Este campo debe ser alfanumérico' })
      ],
      ...
      terms: [
        validations.checked({ message: 'Debes aceptar los terminos y condiciones' })],
    });
    // console.log(_errors);
  ...
  const handleSubmit = async (e) => {
    ...
    _errors = await validate({
      username: [validations.customAsync({
        callback: async (value) => {
          const exist = await user.exists(value)
          console.log(exist);
          return !exist;
