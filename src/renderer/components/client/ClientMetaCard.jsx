...
function ClientMetaCard() {
  ...
  return (
    <div className="col-span-4 p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
      <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <div className='flex justify-between items-center mb-6'>
            ...
            <button
              onClick={() => {
                dispatch(openModal('CLIENT_EDIT'));
              }}
          ...
          <Button onClick={()=>{ dispatch(openModal('ADD_LOAN'))}}>
                prestar dinero
              </Button>
        </div>
